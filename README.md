...
### 1. 데스크톱 앱 (설치 파일)
1. GitHub의 **[Releases]** 탭으로 이동합니다.
2. 최신 버전의 `Chzzk VOD Downloader Setup X.X.X.exe` 파일을 다운로드하여 실행합니다.
3. 앱이 설치되고 자동으로 실행됩니다.
...
(Firefox에서도 지원합니다. 주소창에 'about:debugging#/runtime/this-firefox'을 입력하고 임시 확장 기능 로드... (Load Temporary Add-on...)를 클릭한 후, manifest.json을 선택하면 됩니다.)
---
